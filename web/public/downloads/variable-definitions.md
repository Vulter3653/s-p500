...
**Source dataset:** `panel_2020_2025/firm_year_language_extended.csv`  
...
**Source dataset:** `analysis/descriptive_2020_2025/firm_year_language_extended.csv`  
**Measurement script:** `scripts/measure_brysbaert_concreteness.py, scripts/build_extended_language_panel.py`  
...
**Source dataset:** `analysis/descriptive_2020_2025/firm_year_language_extended.csv`  
**Measurement script:** `scripts/measure_brysbaert_concreteness.py`  
