...
'''
    document = re.sub(r'<script id="production-line-dot-sync">.*?</script>', script.strip(), document, count=1, flags=re.S)
    ...
    print("Applied final production professor-report refinements.")
