  ...
  return (
    <main className="app-shell">
      ...
      <div className="workspace">
        ...
        <section className="literature-section" aria-label="관련 문헌과 연구 위치"><div className="section-intro literature-intro"><p className="eyebrow">LITERATURE MAP</p><h2>문헌 근거와 본 연구의 위치</h2><p>문헌정리.pdf에서 확인한 선행연구를 측정 선택과 해석 범위에 연결했습니다.</p></div><div className="literature-grid"><article className="literature-card"><span className="lit-tag">AI 공시</span><h3>AI 키워드와 공시 강도</h3><p><strong>Mishra, Ewing, &amp; Cooper (2022)</strong>, <strong>Dogan &amp; Kebede Teklie (2026)</strong> 등은 10-K에서 AI 키워드·문장 빈도·공시 여부를 이용해 AI focus 또는 disclosure를 측정했습니다. 본 대시보드의 `ai_disclosure`와 `ai_sentence_count`도 이 흐름에 위치합니다.</p></article><article className="literature-card"><span className="lit-tag">금융 텍스트</span><h3>사전 기반 어조 측정</h3><p><strong>Loughran &amp; McDonald (2011)</strong>는 금융 문맥에 맞는 사전의 필요성을 제시했고, <strong>Henry &amp; Leone (2016)</strong>은 금융 특화 사전과 변화 측정의 유용성을 비교했습니다. 본 연구는 Loughran–McDonald 범주를 보고서·AI 문장 수준으로 구분합니다.</p></article><article className="literature-card"><span className="lit-tag">가독성·복잡성</span><h3>10-K의 길이와 읽기 어려움</h3><p><strong>Loughran &amp; McDonald (2014)</strong>, <strong>Lehavy, Li, &amp; Merkley (2011)</strong>, <strong>Dyer, Lang, &amp; Stice-Lawrence (2017)</strong>는 10-K의 가독성·길이·복잡성을 분석했습니다. 본 연구는 Fog Index와 보고서 단어 수를 기술통계로 제시합니다.</p></article><article className="literature-card"><span className="lit-tag">언어의 방향성</span><h3>미래지향성과 구체성</h3><p><strong>Li (2010)</strong>는 forward-looking statements의 정보성을, <strong>Pan et al. (2018)</strong>은 구체적 언어와 투자자 반응을 다뤘습니다. 본 연구의 시제·concreteness 결과는 이 주제를 확장할 수 있는 관찰 지표지만, 현재 단계에서 성과나 투자자 반응의 인과효과를 검정하지 않습니다.</p></article></div><p className="literature-note">문헌은 변수 설계와 해석의 배경으로 사용했으며, 본 대시보드의 기술통계·상관관계만으로 선행연구의 인과 주장을 재현하거나 검증하지 않습니다.</p></section>
